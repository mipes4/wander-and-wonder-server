 ...
 * decrypts a jsonwebtoken to find a playerId
 * queries the database to find the player with that add id
 * adds it to the request object
 * player can be accessed as req.player when handling a request
 * req.player is a sequelize Player model instance
 *
...
app.post("/authorized_post_request", authMiddleWare, (req, res) => {
  // accessing player that was added to req by the auth middleware
